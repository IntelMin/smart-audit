...
export default function CodeAudit() {
    ...
    return (
      <main className="relative flex flex-col items-center mx-[400px] justify-center bg-[url(/backgrounds/token.svg)] bg-cover bg-center min-h-screen  text-white pt-[123px] space-x-4">
