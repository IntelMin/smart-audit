      ...
      <div className="md:flex-grow bg-[#222226] p-4 text-white text-xl rounded-[24px]">
        ...
        <div className="block md:flex-row gap-4 p-6 rounded-lg overflow-hidden">
          <div className="flex items-center md:items-start mb-4 md:mb-4">
            ...
            <h1 className="text-xl md:text-xl font-bold">{BuyData.name ? BuyData.name : 'ERC20 Token'}</h1>
          </div>
          <p className="flex-grow whitespace-normal text-base md:text-lg leading-tight md:leading-normal md:mt-0 text-xl">
            {BuyData.description ? BuyData.description : 'ERC20 token with the following features: - Token owners can vote on Governance/DAO proposals. - Premint your total supply. - No minting function. This allows users to comfortably know the future supply of the token. Used with Governance/DAO contracts for voting.'}</p>
          <div className="mt-3">
            <span className="py-2 px-4 md:py-1 md:px-2 rounded-full bg-white bg-opacity-20 lg:text-lg md:text-lg sm:text-sm">{BuyData.contract ? BuyData.contract : 'ERC20'}</span>
          </div>
        </div>
          ...
          <div className="relative h-full text-white text-xl rounded-[24px] overflow-hidden flex flex-grow  justify-center">
            ...
            <div className="absolute flex w-full h-[calc(85%)] pt-[calc(15%)] justify-center items-center">
              ...
              <div className="absolute flex w-[130px] h-[168px] justify-center items-center bg-[#FFFFFF] bg-opacity-10 rounded-[8px]">
                <div className="block m-auto text-center items-center justify-center flex" onMouseDown={handleBuy}>
                  <div className="block w-full "><Image src={faTwitter} alt="lock" className="block w-[24px] h-[24px] " /></div>
                  <div className="block"><p className="block text-white text-center text-[16px]">{'Buy'}</p></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="md:w-1/3 max-w-[650px] min-w-[300px]">
        <div className="bl bg-[#18181B] rounded-[24px] w-full text-center text-xl text-white p-6">
          ...
          <div className="h-full">
            <div className="flex items-center rounded-[24px] text-center" style={{
